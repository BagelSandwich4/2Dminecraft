# Source - https://stackoverflow.com/q/55817422
# Posted by LM Programming, modified by community. See post 'Timeline' for change history
...
def gameLoop():
    ...
    sprsp = pg.image.load("Steve_Right.png").convert_alpha()
    cosbg = pg.image.load("Steve_Left.png").convert_alpha()
    done = False
