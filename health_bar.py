"""
Contains the health bar class
"""
import pygame

class HealthBar(pygame.sprite.Sprite):
    """
    This creates the health bar for mobs
    """
    def __init__(self, position, max_hp):
        """
        Setting up the health bar
        Inputs:
            position - tuple containing the x and y 
            coordinates of the health bar as ints
            max_hp - integer representing the
        ...
        # loading images
        full_heart_image = pygame.image.load(
            "sprites\\health\\heart_full.png"
        ).convert_alpha()
    ...
    def damage(self, damage_taken):
        ...
        Inputs:
            damage_taken - integer representing 
            how many half hearts of damage were taken
        """
