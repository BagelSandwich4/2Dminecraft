...
class Hotbar(pygame.sprite.Sprite):
    """
    This is the hotbar class.
    It deals with the hotbar and storing the contents of it.
    """
    ...
    def __init__(self, image, selected_image, position, size, width):
        ...
        Setting up a hotbar
        Inputs:
            image - a string representing
            the path to the .png file of the ui
            selected_image - a string representing
            the path to the .png file of the selected item ui
            position - a tuple representing the
            x and y coordinates of the sprite in pixels
            size - tuple of two integers representing
            the size of the .png uploaded in pixels
    ...
    def change_selected(self, new_selected):
        """
        This assigns the selected slot and
          changes certain varibles based on that
        Inputs:
            new_selected - integer representing
            the index of the new selected slot in the hotbar
        """
        self.selected_slot = new_selected
        # changes position of selected slot
        self.selected_coordinates = [
            self.x_positions[self.selected_slot - 1],
            self.pos[1],
        ]
