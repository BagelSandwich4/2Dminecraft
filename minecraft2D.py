...
VILLAGEHOUSE = build.Build("sprites\\other_sprites\\Village House.png",(10,5),(7,7))
...
END_PLATFORM = platform_func.Platform("sprites\\platforms\\netehr_platform.png",(73,18),(WIDTH_BLOCKS,1))
...
CHEST = interactable.Interactable("sprites\\other_sprites\\chest_front.png",(17,11),(1,1), False)
DIAMOND_ORE = interactable.Interactable("sprites\\blocks\\diamond_ore.png", (36,17), (1,1), True) 
CRAFTING_TABLE = interactable.Interactable("sprites\\blocks\\crafting_table_side.png",(40,17),(1,1), False)
BLAZE = interactable.Interactable("sprites\\other_sprites\\blaze.png",(51,14),(2,4),False)
CHEST2 = interactable.Interactable("sprites\\other_sprites\\chest_front.png",(54,17),(1,1),False)
CRAFTING_TABLE2 = interactable.Interactable("sprites\\blocks\\crafting_table_side.png",(57,17),(1,1),False)
END_PORTAL = interactable.Interactable("sprites\\other_sprites\\end_portal.png",(63,17),(5,1),True)
DRAGON = interactable.Interactable("sprites\\other_sprites\\dragon.png",(77,14),(16,6),False)
...
END_CREDIT = item.Item("sprites\\backgrounds\\end credit.png",(73,6),(640,22))
...
while True:
    ...
    CHEST.interact(P1, IRON_PICKAXE,"sprites\\other_sprites\\chest_front.png",(1,1))
    pygame.display.update()
    FramePerSec.tick(FPS)
    DIAMOND_ORE.interact(P1,DIAMOND,None,(1,1))
    DIAMOND.pick_up(HOTBAR,P1)
    CRAFTING_TABLE.craft(DIAMOND_SWORD,[DIAMOND],HOTBAR,P1)
    BLAZE.interact(P1,BLAZE_ROD,None,(2,4))
    BLAZE_ROD.pick_up(HOTBAR,P1)
    CHEST2.interact(P1,PEARL,None,(1,1))
