"""
Main file to run game, handles creating each object
and the logic in the main game loop
"""
...
# initializing builds
VILLAGE_HOUSE = build.Build(
    "sprites\\other_sprites\\Village House.png", (10, 5), (7, 7)
)
END_BACKGROUND = build.Build(
    "sprites\\backgrounds\\background_end.png", (68, 6), (40, 30)
)
MOUNTAIN_LEFT = build.Build(
    "sprites\\backgrounds\\background_cave_entrance.png", (15, 0), (20, 13)
)
MOUNTAIN_RIGHT = build.Build(
    "sprites\\backgrounds\\background_cave_entrance.png",
    (35, 0),
    (20, 13),
    reversed=True,
)
CAVE_BACKGROUND = build.Build(
    "sprites\\backgrounds\\cave_background.png", (27, 13), (20, 13)
)
NETHER_PORTAL = build.Build(
    "sprites\\other_sprites\\Netherportal_build.png", (43, 13), (4, 5)
)
FORTRESS = build.Build(
    "sprites\\backgrounds\\fort.png", (45, 6), (WIDTH_BLOCKS, HEIGHT_BLOCKS)
)
STRONGHOLD = build.Build(
    "sprites\\backgrounds\\fort.png", (59, 6), (WIDTH_BLOCKS, HEIGHT_BLOCKS)
)
END = build.Build(
    "sprites\\backgrounds\\fort.png", (73, 6), (WIDTH_BLOCKS, HEIGHT_BLOCKS)
)
UNDERGROUND_BACKGROUND = build.Build(
    "sprites\\backgrounds\\underground_background.png",
    (17, 13),
    (WIDTH_BLOCKS, HEIGHT_BLOCKS),
)
UNDERGROUND_BACKGROUND2 = build.Build(
    "sprites\\backgrounds\\underground_background.png",
    (25, 18),
    (WIDTH_BLOCKS, HEIGHT_BLOCKS),
)
UNDERGROUND_NETHER_BACKGROUND = build.Build(
    "sprites\\backgrounds\\underground_nether_background.png",
    (45, 19),
    (WIDTH_BLOCKS, HEIGHT_BLOCKS),
)
UNDERGROUND_NETHER_BACKGROUND2 = build.Build(
    "sprites\\backgrounds\\underground_nether_background.png",
    (48, 18),
    (WIDTH_BLOCKS, HEIGHT_BLOCKS),
)
...
GRASS = platform_func.Platform(
    "sprites\\platforms\\platform_grass.png", (0, 12), (WIDTH_BLOCKS, 1)
)
CAVE_ENTRANCE = platform_func.Platform(
    "sprites\\platforms\\platform_cave_entrance.png", (20, 3), (10, 13)
)
CAVE_CONT = platform_func.Platform(
    "sprites\\platforms\\platform_cave_entrance.png", (27, 6), (10, 13)
)
CAVE_PLATFORM = platform_func.Platform(
    "sprites\\platforms\\cave_platform.png", (37, 18), (WIDTH_BLOCKS, 1)
)
NETHER_PLATFORM = platform_func.Platform(
    "sprites\\platforms\\nether_platform.png", (45, 18), (WIDTH_BLOCKS, 1)
)
STRONGHOLD_PLATFORM = platform_func.Platform(
    "sprites\\platforms\\nether_platform.png", (59, 18), (WIDTH_BLOCKS, 1)
)
END_PLATFORM = platform_func.Platform(
    "sprites\\platforms\\end_platform.png",
    (68, 7),
    (WIDTH_BLOCKS, HEIGHT_BLOCKS),
)
LOWER_END_PLATFORM = platform_func.Platform(
    "sprites\\platforms\\lower_end_platform.png",
    (68, 12),
    (WIDTH_BLOCKS, HEIGHT_BLOCKS),
)
...
END_CREDIT = item.Item(
    "sprites\\backgrounds\\end credit.png", (73, 6), (40 / 1.6, 22 / 1.6)
)

# initializing interactables
CHEST = interactable.Interactable(
    "sprites\\other_sprites\\chest_front.png", (17, 11), (1, 1), False, None
)
DIAMOND_ORE = interactable.Interactable(
    "sprites\\blocks\\diamond_ore.png", (36, 17), (1, 1), True, IRON_PICKAXE
)
CRAFTING_TABLE = interactable.Interactable(
    "sprites\\blocks\\crafting_table_side.png", (40, 17), (1, 1), False, None
)
CHEST2 = interactable.Interactable(
    "sprites\\other_sprites\\chest_front.png", (54, 17), (1, 1), False, None
)
CRAFTING_TABLE2 = interactable.Interactable(
    "sprites\\blocks\\crafting_table_side.png", (57, 17), (1, 1), False, None
)
END_PORTAL = interactable.Interactable(
    "sprites\\other_sprites\\end_portal.png",
    (63, 17),
    (5, 1),
    True,
    EYE_OF_ENDER,
...
# initalizing mobs
DRAGON = mob.Mob(
    "sprites\\other_sprites\\dragon.png",
    (77, 11),
    (16, 6),
    DIAMOND_SWORD,
    40,
...
HOTBAR = hotbar.Hotbar(
    "sprites\\other_sprites\\hotbar.png",
    "sprites\\other_sprites\\selected_hotbar_slot.png",
    (WIDTH / 3.3, HEIGHT - 15),
    [135, 16],
    WIDTH,
)
...
while True:
    ...
    CHEST.interact(
        P1,
        IRON_PICKAXE,
        "sprites\\other_sprites\\chest_front.png",
        (1, 1),
        HOTBAR,
    )
    ...
    END_PORTAL.interact(
        P1,
        None,
        "sprites\\other_sprites\\filled_end_portal.png",
        (5, 1),
        HOTBAR,
    )
    # scrolling of screen
    ...
    for entity in all_sprites:
        if entity.visible:
            ...
            displaysurface.blit(
                entity.image, (int(draw_pos[0]), int(draw_pos[1]))
            )
    # draws health bar
    for mob in mobs:
        if mob.health_bar.hp % 2 == 0:
            ...
            for i in range(int(mob.health_bar.hp / 2)):
                # drawing the hearts
                draw_pos = (
                    mob.health_bar.x_positions[i] - scroll_x,
                    mob.health_bar.y_position - scroll_y,
                )
                displaysurface.blit(
                    mob.health_bar.full_heart,
                    (int(draw_pos[0]), int(draw_pos[1])),
                )
        else:
    ...
    if DRAGON.end:
        ...
        # drawing the credits
        displaysurface.blit(
            END_CREDIT.image_normal, (blocks_to_pixels.blocks_to_pixels(-2), 0)
        )
